param(
    ...
    [string]$OutputRoot="$PSScriptRoot/runs/density-sampling-v1",
    [switch]$Pilot
)
...
$files=@('src/Renderer/SmokeTransportProbe.cpp','src/Renderer/SmokeProjectionExperiment.cpp','src/Renderer/SmokeAdvectionReference.cpp',
    ...
    'diagnostics/Run-SmokeDensitySampling.ps1','diagnostics/analyze_transport_probe.py','diagnostics/analyze_projection.py','diagnostics/analyze_density_sampling.py')
